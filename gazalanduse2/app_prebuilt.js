...
var BasicApp = React.createClass({
  componentDidMount() {
    ...
    map.addControl(new ol.control.OverviewMap({collapsed: true, layers: [overviewMapBaseLayer, lyr_gazastrip_municipalboundaries,lyr_gis_osm_landuse_a_free_1,lyr_gazastrip_neighbourhoods_points,lyr_gazastrip_fishingzone_219_polygon]}));
  },
  _toggle(el) {
...
{exclude: true, jsx: React.createElement("a", {className:"navbar-brand", href:"#"}, "ga za")}];
